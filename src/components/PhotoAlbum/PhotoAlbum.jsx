...
const {FiCamera,FiPlus,FiTrash2,FiUser,FiCalendar,FiMaximize2,FiUpload,FiHeart,FiMessageCircle,FiX}=FiIcons;
...
const PhotoAlbum=()=> {
  ...
  // Enhanced close modal function with escape key support
  const closeModal=()=> {
  ...
  return (
    <div className="max-w-6xl mx-auto">
              ...
              >
                ...
                {newPhoto.image ? (
                  <div className="space-y-2">
                    <img src={newPhoto.image} alt="Preview" className="max-h-32 mx-auto rounded" />
                  ...
                  <>
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      JPG,PNG,GIF,WebP (max 10MB per billede)
                    </p>
                  </>
                )}
              </div>
      ...
      {/* Enhanced Photo Modal with better close options */}
      {selectedPhoto && (
        <motion.div
          initial={{opacity: 0}}
          animate={{opacity: 1}}
        ...
        >
          ...
          <button
            onClick={closeModal}
            className="fixed top-4 right-4 z-60 p-3 bg-white/20 backdrop-blur-sm rounded-full text-white hover:bg-white/30 transition-all duration-200 border border-white/20"
            style={{zIndex: 60}}
          >
            ...
            <div className="p-4 flex-shrink-0">
              ...
              <div className="mt-3 text-center">
                <p className="text-xs text-gray-400">
                  Tryk udenfor billedet eller på X for at lukke
                </p>
              </div>
            </div>
          </motion.div>
