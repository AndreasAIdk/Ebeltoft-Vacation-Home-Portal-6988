...
const Blog = () => {
  ...
  useEffect(() => {
    const storedPosts = JSON.parse(localStorage.getItem('sommerhus_blog_posts') || '[]');
  ...
  const handleSubmit = (e) => {
    ...
    if (newPost.title.trim() && newPost.content.trim()) {
      ...
      localStorage.setItem('sommerhus_blog_posts', JSON.stringify(updatedPosts));
    ...
    <div className="max-w-4xl mx-auto">
      <div className="bg-white rounded-2xl shadow-lg p-6 mb-6">
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-gray-600 mt-1">
              Guide til nedlukning og opstart af sommerhuset
            </p>
          </div>
          <motion.button
        ...
        {showForm && (
          ...
          >
            <h3 className="text-lg font-semibold text-ebeltoft-dark mb-4">Opret nyt indlæg</h3>
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  placeholder="f.eks. Nedlukning for vinteren 2024"
              ...
              <div>
                ...
                <div className="border border-gray-300 rounded-lg overflow-hidden">
                  <ReactQuill
                    ...
                    modules={modules}
                    formats={formats}
                    placeholder="Beskriv proceduren for nedlukning eller opstart..."
                    className="bg-white"
                  />
                </div>
              </div>
      ...
      <div className="space-y-6">
        {posts.length === 0 ? (
          <div className="bg-white rounded-xl shadow-md p-8 text-center">
            ...
            <h3 className="text-lg font-medium text-gray-800 mb-2">Ingen indlæg endnu</h3>
            <p className="text-gray-600">Opret det første indlæg om nedlukning eller opstart af sommerhuset.</p>
          </div>
        ) : (
          posts.map((post) => (
            <motion.article
